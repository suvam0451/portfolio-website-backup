...
- Creating AssetStreams
- Maintaining folder references in VSCode
- Requesting updates after new batch of assets are added
- Importing assets to UE4
- Uses vanilla Python API. Always imports in silent mode.
- Implementation details (Extra)
