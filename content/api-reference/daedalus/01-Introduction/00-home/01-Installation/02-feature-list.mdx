---
path: "/docs/trailblazer/features"
...
The following are the showcase features that come with this extension.
...
Context menu is a powerful module which uses **all other code modules** to
provide you customized auto-completion on the fly.

You definitely need this to fully utilize this extension to the maximum potential.

Learn more [here...](/docs/trailblazer/context-keys/)
...
Now, the script is called in UE4 to get your assets from multiple folders with multiple configs.
...
**Use Case** : If you store your assets in cloud drives and start a new projects from scratch every few weeks,
this tool will make sure your imports are in order and your source files are safe.
[Learn More...](/docs/trailblazer/hello-asset-streams)
...
NOTE : **For now, only windows support** is available. I will appreciate anyone testing this on other client OS.
...
This is very important for better search results and significantly improved intellisense. [Learn more...](/docs/trailblazer/workspace-configurations)
