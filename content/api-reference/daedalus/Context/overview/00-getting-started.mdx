---
path: "/docs/trailblazer/context-keys/"
...
- **Initializing components** : *copies* initialization code for variables right from header. 
...
Now head to the next page and setup key bindings for this.

If you already know how to do that, head to the binding list to see under which context each function is called.
