...
If you already know how to do that, head to [activation context](/docs/trailblazer/context-keys/2) section to see under which context each function is called.
