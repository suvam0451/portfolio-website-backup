---
path: "/docs/sleeping-forest/context-keys/1"
...
To learn the contexts in which specific commands get called, head to [activation context](/docs/sleeping-forest/context-keys/2).
