---
path: "/api/daedalus/class-generator/2"
title: "Class Generator module"
date: "2020-01-10"
submoduleID: 2
seriesID: 1
seriesIndex: 3
...
In this page, I will show how you can add your own class definitions.

If you use an engine class often and want it added, just ping me.
If it's something useful people will end up using often, I will be glab to patch it through.
