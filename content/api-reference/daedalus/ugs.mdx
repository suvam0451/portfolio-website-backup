...
Used to load assets. Try not to load assets directly in C++ like this(except data assets). There are better options available
...
- Include "ConstructorHelpers.h". Done automatically if usingcommandlet
...
- Don't add "\_C"(This is only for BP classes) or "StaticMesh.YourMesh_C"(This is legacy))
