...
| ------------- | -------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| uprop         | [Overview](/docs/sleeping-forest/uprop-snippets), [Full List](/docs/sleeping-forest/snippet-lists/uprop) | Adding UPROPERTY()                          |
...
| uabbr         |                                                                                                          | Abbreviations for long classes              |
| ugas          |                                                                                                          | Gameplay Ability Systems **WIP**            |
| umat          |                                                                                                          | Material handling through code              |
| umatnode      |                                                                                                          | Creation of advanced material nodes **WIP** |
| ue4_suvam0451 |                                                                                                          | Extra stuff like loops, switches            |
