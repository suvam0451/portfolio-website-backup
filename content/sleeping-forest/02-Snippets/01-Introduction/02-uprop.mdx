...
There degree of freedom exposed to designer in editor can be switched like this using the `context key`.
...
**NOTE:** The visible delay has been reduced significantly in v0.6.11.
