---
path: "/docs/sleeping-forest/extension-files"
...
- [adding header pack](/docs/sleeping-forest/adding-header-packs)
- [add/make buildspaces](/docs/sleeping-forest/extending-the-buildspace)
...
- [Extending header packs](/docs/sleeping-forestadding-header-packs)
- [Extending buildspaces](/docs/sleeping-forest/extending-the-buildspace)
- [Customizing exclusions](/docs/sleeping-forest/workspace-configurations)
