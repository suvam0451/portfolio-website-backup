---
path: "/ue4-tuts/working-with-git-for-unreal-engine-projects-01"
...
<Alert title="Title" type="info">
    Trust me darling, Im a bad liar.
</Alert>
#### As an artist
...
4. Webhooks, DevOps, Automation, Docker, Kubernetes(*Not covered here*)
